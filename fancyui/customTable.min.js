 ...
 * @license New BSD License <http://creativecommons.org/licenses/BSD/>
 */
function(){angular.module("ngTable").factory("NgTableParams",["$q","$log","$filter","ngTableDefaults","ngTableGetDataBcShim","ngTableDefaultGetData","ngTableEventsChannel",function(n,e,a,o,i,r,s){var l=function(n){return!isNaN(parseFloat(n))&&isFinite(n)},c=function(a,c){function u(n){var t=S.groupOptions&&S.groupOptions.defaultSort;if(angular.isFunction(n))return null==n.sortDirection&&(n.sortDirection=t),n;if(angular.isString(n)){var e={};return e[n]=t,e}if(angular.isObject(n)){for(var a in n)null==n[a]&&(n[a]=t);return n}return n}function f(n){var t=[];for(var e in n)t.push(("asc"===n[e]?"+":"-")+e);return t}function d(){var n={params:D};return angular.isFunction(D.group)&&(n.groupSortDirection=D.group.sortDirection),n}function p(){var n=D.filter&&D.filter.$,t=y&&y.params.filter&&y.params.filter.$;return!angular.equals(n,t)}function m(){S.filterOptions.filterDelay===C.filterDelay&&S.total<=S.filterOptions.filterDelayThreshold&&S.getData===O.getData&&(S.filterOptions.filterDelay=0)}function g(){var t=S.getDataFnAdaptor(S.getData);return n.when(t.call(S,E))}function b(){var t=S.getGroupsFnAdaptor(S.getGroups);return n.when(t.call(S,E))}function h(t){var e=S.interceptors||[];return e.reduce(function(t,e){var a=e.response&&e.response.bind(e)||n.when,o=e.responseError&&e.responseError.bind(e)||n.reject;return t.then(function(n){return a(n,E)},function(n){return o(n,E)})},t())}function v(){function t(n){return r(n.settings().dataset,n)}function e(t){var e,o=t.group(),i=void 0;if(angular.isFunction(o))e=o,i=o.sortDirection;else{var s=Object.keys(o)[0];i=o[s],e=function(n){return a(n,s)}}var l=t.settings(),c=l.dataOptions;l.dataOptions={applyPaging:!1};var u=l.getDataFnAdaptor(l.getData),d=n.when(u.call(l,t));return d.then(function(n){var a={};angular.forEach(n,function(n){var t=e(n);a[t]=a[t]||{data:[],$hideRows:!l.groupOptions.isExpanded,value:t},a[t].data.push(n)});var o=[];for(var s in a)o.push(a[s]);if(i){var c=r.getOrderByFn(),u=f({value:i});o=c(o,u)}return r.applyPaging(o,t)})["finally"](function(){l.dataOptions=c})}function a(n,t){if("string"==typeof t&&(t=t.split(".")),void 0!==n){if(0===t.length)return n;if(null!==n)return a(n[t[0]],t.slice(1))}}return{getDataFnAdaptor:angular.identity,getGroupsFnAdaptor:angular.identity,getData:t,getGroups:e}}"boolean"==typeof a&&(this.isNullInstance=!0);var y,w,E=this,k=!1,x=[],z=function(){S.debugMode&&e.debug&&e.debug.apply(e,arguments)},C={filterComparator:void 0,filterDelay:500,filterDelayThreshold:1e4,filterFilterName:void 0,filterFn:void 0,filterLayout:"stack"},T={defaultSort:"asc",isExpanded:!0},O=v();this.data=[],this.parameters=function(n,t){if(t=t||!1,angular.isDefined(n)){for(var e in n){var a=n[e];if(t&&e.indexOf("[")>=0){for(var o=e.split(/\[(.*)\]/).reverse(),i="",r=0,s=o.length;r<s;r++){var c=o[r];if(""!==c){var f=a;a={},a[i=c]=l(f)?parseFloat(f):f}}"sorting"===i&&(D[i]={}),D[i]=angular.extend(D[i]||{},a[i])}else"group"===e?D[e]=u(n[e]):D[e]=l(n[e])?parseFloat(n[e]):n[e]}return z("ngTable: set parameters",D),this}return D},this.settings=function(n){if(angular.isDefined(n)){n.filterOptions&&(n.filterOptions=angular.extend({},S.filterOptions,n.filterOptions)),n.groupOptions&&(n.groupOptions=angular.extend({},S.groupOptions,n.groupOptions)),angular.isArray(n.dataset)&&(n.total=n.dataset.length),n.getData&&n.getData.length>1&&(n.getDataFnAdaptor=i),n.getGroups&&n.getGroups.length>2&&(n.getGroupsFnAdaptor=i);var t=S.dataset;S=angular.extend(S,n),angular.isArray(n.dataset)&&m();var e=n.hasOwnProperty("dataset")&&n.dataset!=t;if(e){k&&this.page(1),k=!1;var a=function(){s.publishDatasetChanged(E,n.dataset,t)};x?x.push(a):a()}return z("ngTable: set settings",S),this}return S},this.page=function(n){return angular.isDefined(n)?this.parameters({page:n}):D.page},this.total=function(n){return angular.isDefined(n)?this.settings({total:n}):S.total},this.count=function(n){return angular.isDefined(n)?this.parameters({count:n,page:1}):D.count},this.filter=function(n){if(angular.isDefined(n)&&angular.isObject(n))return this.parameters({filter:n,page:1});if(n===!0){for(var t=Object.keys(D.filter),e={},a=0;a<t.length;a++){var o=D.filter[t[a]];null!=o&&""!==o&&(e[t[a]]=o)}return e}return D.filter},this.group=function(n,t){if(!angular.isDefined(n))return D.group;var e={page:1};if(angular.isFunction(n)&&angular.isDefined(t))n.sortDirection=t,e.group=n;else if(angular.isDefined(n)&&angular.isDefined(t)){var a={};a[n]=t,e.group=a}else e.group=n;return this.parameters(e),this},this.sorting=function(n){if(2==arguments.length){var t={};return t[n]=arguments[1],this.parameters({sorting:t}),this}return angular.isDefined(n)?this.parameters({sorting:n}):D.sorting},this.isSortBy=function(n,t){return void 0!==t?angular.isDefined(D.sorting[n])&&D.sorting[n]==t:angular.isDefined(D.sorting[n])},this.orderBy=function(){return f(D.sorting)},this.generatePagesArray=function(n,t,e,a){arguments.length||(n=this.page(),t=this.total(),e=this.count());var o,i,r,s,l;if(a=a&&a<6?6:a,l=[],s=Math.ceil(t/e),s>1){l.push({type:"prev",number:Math.max(1,n-1),active:n>1}),l.push({type:"first",number:1,active:n>1,current:1===n}),i=Math.round((S.paginationMaxBlocks-S.paginationMinBlocks)/2),r=Math.max(2,n-i),o=Math.min(s-1,n+2*i-(n-r)),r=Math.max(2,r-(2*i-(o-r)));for(var c=r;c<=o;)c===r&&2!==c||c===o&&c!==s-1?l.push({type:"more",active:!1}):l.push({type:"page",number:c,active:n!==c,current:n===c}),c++;l.push({type:"last",number:s,active:n!==s,current:n===s}),l.push({type:"next",number:Math.min(s,n+1),active:n<s})}return l},this.isDataReloadRequired=function(){return!k||!angular.equals(d(),y)||p()},this.hasFilter=function(){return Object.keys(this.filter(!0)).length>0},this.hasGroup=function(n,t){return null==n?angular.isFunction(D.group)||Object.keys(D.group).length>0:angular.isFunction(n)?null==t?D.group===n:D.group===n&&n.sortDirection===t:null==t?Object.keys(D.group).indexOf(n)!==-1:D.group[n]===t},this.hasFilterChanges=function(){var n=y&&y.params.filter;return!angular.equals(D.filter,n)||p()},this.url=function(n){function e(t,e){n?o.push(e+"="+encodeURIComponent(t)):o[e]=encodeURIComponent(t)}function a(n,t){return"group"===t||angular.isDefined(n)&&""!==n}n=n||!1;var o=n?[]:{};for(var i in D)if(D.hasOwnProperty(i)){var r=D[i],s=encodeURIComponent(i);if("object"===("undefined"==typeof r?"undefined":t(r))){for(var l in r)if(a(r[l],i)){var c=s+"["+encodeURIComponent(l)+"]";e(r[l],c)}}else!angular.isFunction(r)&&a(r,i)&&e(r,s)}return o},this.reload=function(){var t=this,e=null;S.$loading=!0,y=angular.copy(d()),k=!0,e=h(t.hasGroup()?b:g),z("ngTable: reload data");var a=t.data;return e.then(function(n){return S.$loading=!1,w=null,t.data=n,s.publishAfterReloadData(t,n,a),t.reloadPages(),S.$scope&&S.$scope.$emit("ngTableAfterReloadData"),n})["catch"](function(t){return w=y,n.reject(t)})},this.hasErrorState=function(){return!(!w||!angular.equals(w,d()))},this.reloadPages=function(){var n;return function(){var t=n,e=E.generatePagesArray(E.page(),E.total(),E.count());angular.equals(t,e)||(n=e,s.publishPagesChanged(this,e,t))}}();var D={page:1,count:10,filter:{},sorting:{},group:{}};angular.extend(D,o.params);var S={$scope:null,$loading:!1,dataset:null,total:0,defaultSort:"desc",filterOptions:angular.copy(C),groupOptions:angular.copy(T),counts:[10,25,50,100],interceptors:[],paginationMaxBlocks:11,paginationMinBlocks:5,sortingIndicator:"span"};return this.settings(O),this.settings(o.settings),this.settings(c),this.parameters(a,!0),s.publishAfterCreated(this),angular.forEach(x,function(n){n()}),x=null,this};return c}]),angular.module("ngTable").factory("ngTableParams",["NgTableParams",function(n){return n}])}(),/**
 * ngTable: Table + Angular JS
 *
 * @author Vitalii Savchuk <esvit666@gmail.com>
 * @url https://github.com/esvit/ng-table/
